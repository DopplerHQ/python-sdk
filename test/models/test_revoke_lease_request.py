...
class TestRevokeLeaseRequestModel(unittest.TestCase):
    ...
    def test_revoke_lease_request(self):
        ...
        test_model = RevokeLeaseRequest(
            slug="atque", dynamic_secret="reiciendis", config="autem", project="omnis"
        )
        self.assertEqual(test_model.slug, "atque")
        self.assertEqual(test_model.dynamic_secret, "reiciendis")
        self.assertEqual(test_model.config, "autem")
        self.assertEqual(test_model.project, "omnis")
