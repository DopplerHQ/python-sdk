...
class TestConfigLogs_(unittest.TestCase):
    ...
    def test_list(self):
        ...
        response = test_service.list("suscipit", "vitae", 6, 6)
    ...
    def test_list_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = ConfigLogs("testkey")
            test_service.list("optio", "sit", 3, 6)
        responses.reset()
    ...
    def test_get(self):
        ...
        # call the method to test
        test_service = ConfigLogs("testkey")
        response = test_service.get("molestiae", "illum", "nostrum")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_get_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = ConfigLogs("testkey")
            test_service.get("repudiandae", "saepe", "ipsam")
        responses.reset()
    ...
    def test_rollback(self):
        ...
        # call the method to test
        test_service = ConfigLogs("testkey")
        response = test_service.rollback("temporibus", "quam", "at")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_rollback_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = ConfigLogs("testkey")
            test_service.rollback("ab", "optio", "dolorem")
        responses.reset()
