...
class TestConfigLogs_(unittest.TestCase):
    ...
    def test_list(self):
        ...
        response = test_service.list("numquam", "deserunt", 5, 8)
    ...
    def test_list_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = ConfigLogs("testkey")
            test_service.list("hic", "optio", 4, 3)
        responses.reset()
    ...
    def test_get(self):
        ...
        # call the method to test
        test_service = ConfigLogs("testkey")
        response = test_service.get("qui", "illum", "similique")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_get_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = ConfigLogs("testkey")
            test_service.get("numquam", "illum", "dolorum")
        responses.reset()
    ...
    def test_rollback(self):
        ...
        # call the method to test
        test_service = ConfigLogs("testkey")
        response = test_service.rollback("quod", "in", "quam")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_rollback_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = ConfigLogs("testkey")
            test_service.rollback("quasi", "eos", "neque")
        responses.reset()
