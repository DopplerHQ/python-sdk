...
class TestSyncs_(unittest.TestCase):
    ...
    def test_create(self):
        ...
        response = test_service.create("voluptates", "deserunt", {})
    ...
    def test_create_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Syncs("testkey")
            test_service.create("quaerat", "enim", {})
        responses.reset()
    ...
    def test_get(self):
        ...
        # call the method to test
        test_service = Syncs("testkey")
        response = test_service.get("cumque", "necessitatibus", "numquam")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_get_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Syncs("testkey")
            test_service.get("libero", "adipisci", "deleniti")
        responses.reset()
    ...
    def test_delete(self):
        ...
        # call the method to test
        test_service = Syncs("testkey")
        response = test_service.delete(True, "ducimus", "quia", "quibusdam")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_delete_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Syncs("testkey")
            test_service.delete(True, "magni", "sequi", "natus")
        responses.reset()
