...
class TestSyncs_(unittest.TestCase):
    ...
    def test_create(self):
        ...
        response = test_service.create("earum", "dicta", {})
    ...
    def test_create_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Syncs("testkey")
            test_service.create("similique", "officiis", {})
        responses.reset()
    ...
    def test_get(self):
        ...
        # call the method to test
        test_service = Syncs("testkey")
        response = test_service.get("sint", "minima", "dolorum")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_get_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Syncs("testkey")
            test_service.get("placeat", "repudiandae", "tenetur")
        responses.reset()
    ...
    def test_delete(self):
        ...
        # call the method to test
        test_service = Syncs("testkey")
        response = test_service.delete(True, "reprehenderit", "aut", "amet")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_delete_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Syncs("testkey")
            test_service.delete(True, "sequi", "harum", "nesciunt")
        responses.reset()
