...
class TestEnvironments_(unittest.TestCase):
    ...
    def test_get(self):
        ...
        response = test_service.get("necessitatibus", "ipsam")
    ...
    def test_get_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Environments("testkey")
            test_service.get("voluptatum", "est")
        responses.reset()
    ...
    def test_rename(self):
        ...
        # call the method to test
        test_service = Environments("testkey")
        response = test_service.rename("laboriosam", "hic", {})
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_rename_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Environments("testkey")
            test_service.rename("nobis", "numquam", {})
        responses.reset()
    ...
    def test_delete(self):
        ...
        # call the method to test
        test_service = Environments("testkey")
        response = test_service.delete("excepturi", "consequatur")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_delete_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Environments("testkey")
            test_service.delete("consectetur", "ut")
        responses.reset()
    ...
    def test_list(self):
        ...
        # call the method to test
        test_service = Environments("testkey")
        response = test_service.list("earum")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_create(self):
        ...
        # call the method to test
        test_service = Environments("testkey")
        response = test_service.create("voluptatum", {})
        self.assertEqual(response, {})
        responses.reset(),
