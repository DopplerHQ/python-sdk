...
class TestEnvironments_(unittest.TestCase):
    ...
    def test_get(self):
        ...
        response = test_service.get("animi", "sequi")
    ...
    def test_get_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Environments("testkey")
            test_service.get("architecto", "facere")
        responses.reset()
    ...
    def test_rename(self):
        ...
        # call the method to test
        test_service = Environments("testkey")
        response = test_service.rename("laboriosam", "nostrum", {})
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_rename_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Environments("testkey")
            test_service.rename("beatae", "alias", {})
        responses.reset()
    ...
    def test_delete(self):
        ...
        # call the method to test
        test_service = Environments("testkey")
        response = test_service.delete("deserunt", "ratione")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_delete_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Environments("testkey")
            test_service.delete("quia", "eaque")
        responses.reset()
    ...
    def test_list(self):
        ...
        # call the method to test
        test_service = Environments("testkey")
        response = test_service.list("accusamus")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_create(self):
        ...
        # call the method to test
        test_service = Environments("testkey")
        response = test_service.create("voluptatibus", {})
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_create_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Environments("testkey")
            test_service.create("consectetur", {})
        responses.reset()
