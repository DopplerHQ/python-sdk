...
class TestSecrets_(unittest.TestCase):
    ...
    def test_list(self):
        ...
        response = test_service.list(
            "minus", "molestiae", "mollitia", True, 3, "soluta", True
        )
    ...
    def test_list_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Secrets("testkey")
            test_service.list("neque", "dolorum", "dicta", True, 6, "quaerat", True)
        responses.reset()
    ...
    def test_get(self):
        ...
        # call the method to test
        test_service = Secrets("testkey")
        response = test_service.get("Simone", "labore", "repellat")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_get_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Secrets("testkey")
            test_service.get("Florencio", "at", "adipisci")
        responses.reset()
    ...
    def test_download(self):
        ...
        # call the method to test
        test_service = Secrets("testkey")
        response = test_service.download("animi", "maiores", "json", "camel", True, 5)
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_download_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Secrets("testkey")
            test_service.download("porro", "rem", "json", "camel", True, 6)
        responses.reset()
    ...
    def test_list_names(self):
        ...
        # call the method to test
        test_service = Secrets("testkey")
        response = test_service.list_names("veniam", "deserunt", True, True)
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_list_names_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Secrets("testkey")
            test_service.list_names("ducimus", "eum", True, True)
        responses.reset()
