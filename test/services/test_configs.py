...
class TestConfigs_(unittest.TestCase):
    ...
    def test_list(self):
        ...
        response = test_service.list("sit", "officia", 9, 4)
    ...
    def test_list_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.list("nobis", "porro", 6, 5)
        responses.reset()
    ...
    def test_get(self):
        ...
        # call the method to test
        test_service = Configs("testkey")
        response = test_service.get("nam", "quam")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_list_trusted_ips(self):
        ...
        # call the method to test
        test_service = Configs("testkey")
        response = test_service.list_trusted_ips("amet", "minima")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_list_trusted_ips_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.list_trusted_ips("est", "quisquam")
        responses.reset()
    ...
    def test_add_trusted_ip(self):
        ...
        # call the method to test
        test_service = Configs("testkey")
        response = test_service.add_trusted_ip("dolorum", "possimus", {})
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_add_trusted_ip_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.add_trusted_ip("tempora", "ipsa", {})
        responses.reset()
    ...
    def test_delete_trusted_ip(self):
        ...
        # call the method to test
        test_service = Configs("testkey")
        response = test_service.delete_trusted_ip("sed", "expedita", {})
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_delete_trusted_ip_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.delete_trusted_ip("maxime", "ab", {})
        responses.reset()
