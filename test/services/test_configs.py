...
class TestConfigs_(unittest.TestCase):
    ...
    def test_list(self):
        ...
        response = test_service.list("excepturi", "tempora", 3, 7)
    ...
    def test_list_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.list("optio", "id", 2, 8)
        responses.reset()
    ...
    def test_get(self):
        ...
        # call the method to test
        test_service = Configs("testkey")
        response = test_service.get("ratione", "quas")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_get_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.get("eaque", "dignissimos")
        responses.reset()
    ...
    def test_list_trusted_ips(self):
        ...
        # call the method to test
        test_service = Configs("testkey")
        response = test_service.list_trusted_ips("quisquam", "inventore")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_list_trusted_ips_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.list_trusted_ips("asperiores", "consequuntur")
        responses.reset()
    ...
    def test_add_trusted_ip(self):
        ...
        # call the method to test
        test_service = Configs("testkey")
        response = test_service.add_trusted_ip("aperiam", "dignissimos", {})
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_add_trusted_ip_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.add_trusted_ip("ex", "temporibus", {})
        responses.reset()
    ...
    def test_delete_trusted_ip(self):
        ...
        # call the method to test
        test_service = Configs("testkey")
        response = test_service.delete_trusted_ip("amet", "sed", {})
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_delete_trusted_ip_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Configs("testkey")
            test_service.delete_trusted_ip("sapiente", "ducimus", {})
        responses.reset()
