...
results = sdk.secrets.list(
	...
	dynamic_secrets_ttl_sec = -50016862,
	secrets = 'ut enim eu cupidatat dolor',
...
results = sdk.environments.get(
	project = 'consequat',
	environment = 'consequat nulla cillum'
)
...
results = sdk.environments.delete(
	project = 'Excepteur',
	environment = 'magna Ut anim incididunt'
)
...
results = sdk.environments.rename(
	request_body=input,
	project = 'reprehenderit et pariatur',
	environment = 'ut'
)
...
input = {
	'name': 'ad aliquip ex',
	'slug': 'consectetur consequat anim'
}
...
sdk = DopplerSDK()
sdk.set_bearer_token(DOPPLERSDK_BEARER_TOKEN)
results = sdk.environments.list(project = 'ut dolor aliqua minim qui')
...
input = {
	'access': 'read',
	'config': 'CONFIG_NAME',
	'expire_at': '1936-06-17T09:01:28.0Z',
	'name': 'TOKEN_NAME',
	'project': 'PROJECT_NAME'
}
...
sdk.set_bearer_token(DOPPLERSDK_BEARER_TOKEN)
input = {
	'config': 'consectetur veniam non ut amet',
	'dynamic_secret': 'laboris',
	'project': 'aliqua esse reprehenderit',
	'slug': 'voluptate sunt'
}
...
sdk = DopplerSDK()
sdk.set_bearer_token(DOPPLERSDK_BEARER_TOKEN)
results = sdk.integrations.get(integration = 'adipisicing aute elit')
...
sdk = DopplerSDK()
sdk.set_bearer_token(DOPPLERSDK_BEARER_TOKEN)
results = sdk.integrations.delete(integration = 'ullamco')
...
input = {
	'data': {},
	'import_option': 'none',
	'integration': 'nostrud amet culpa occaecat aute'
}
results = sdk.syncs.create(
	request_body=input,
	project = 'voluptate consequat exercitation sunt',
	config = 'anim irure'
)
...
results = sdk.syncs.get(
	project = 'Duis commodo sunt',
	config = 'culpa sint deserunt sunt',
	sync = 'sit'
)
...
results = sdk.syncs.delete(
	project = 'et',
	config = 'anim id nulla labore amet',
	sync = 'Lorem fugiat dolor',
