...
results = sdk.secrets.list(
	...
	dynamic_secrets_ttl_sec = 6962808,
	secrets = 'secrets',
...
request_body = {
	'access': 'read',
	'config': 'CONFIG_NAME',
	'expire_at': '1926-07-09T11:43:11.0Z',
	'name': 'TOKEN_NAME',
	'project': 'PROJECT_NAME'
}
...
sdk.set_access_token(DOPPLERSDK_ACCESS_TOKEN)
request_body = {
	'environments': ["irure nisi in laborum aute","veniam proident dolor"],
	'role': 'role',
	'slug': 'slug',
...
sdk.set_access_token(DOPPLERSDK_ACCESS_TOKEN)
request_body = {
	'environments': ["exercitation","fugiat pariatur ad mollit"],
	'role': 'role'
}
...
request_body = {
	'name': 'name',
	'workplace_role': {"identifier":"identifier","permissions":["reprehenderit ea","in enim veniam exercitation"]}
}
...
request_body = {
	'name': 'name',
	'workplace_role': {"identifier":"identifier","permissions":["eu esse non","culpa aliquip non velit ea"]}
}
