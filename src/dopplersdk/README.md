...
results = sdk.secrets.list(
	...
	dynamic_secrets_ttl_sec = 43007685,
	secrets = 'secrets',
...
request_body = {
	'access': 'read',
	'config': 'CONFIG_NAME',
	'expire_at': '1914-10-12T21:36:48.0Z',
	'name': 'TOKEN_NAME',
	'project': 'PROJECT_NAME'
}
...
sdk.set_access_token(DOPPLERSDK_ACCESS_TOKEN)
request_body = {
	'environments': ["cillum adipisicing","esse dolore"],
	'role': 'role',
	'slug': 'slug',
...
sdk.set_access_token(DOPPLERSDK_ACCESS_TOKEN)
request_body = {
	'environments': ["aute ut ut irure consectetur","tempor"],
	'role': 'role'
}
...
request_body = {
	'name': 'name',
	'workplace_role': {"identifier":"identifier","permissions":["minim voluptate id deserunt","elit officia"]}
}
...
request_body = {
	'name': 'name',
	'workplace_role': {"identifier":"identifier","permissions":["Excepteur dolor","ut veniam id aute aliqua"]}
}
